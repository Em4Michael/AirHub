...
// Format currency (NGN)
export const formatCurrency = (amount: number | null | undefined, currency = 'NGN'): string => {
...
export const getPerformanceTier = (percentage: number): { tier: string; color: string } => {
...
export const getWeekNumber = (date: string | Date): { week: number; year: number } => {
